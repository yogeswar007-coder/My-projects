...
// Function to update the button labels based on input fields
...
// Add event listeners to update the button labels
...
function reset() {
    ...
    updateButtonLabels(); // Update button labels after reset
}
